...
class Experiment:
    ...
    def run(self, population_size, generations, mutation_rate, k, hidden_layer_configurations=None):
...
if __name__ == '__main__':
    ...
    generations = 150
    mutation_rate = 0.001
    hidden_layer_configs = [[40, 20]]  # 2 hidden layers with specified nodes
    
    experiment.run(population_size, generations, mutation_rate, k=10, hidden_layer_configurations=hidden_layer_configs)
